...
{
public:
	TexureSampler1F(float* data, int w, int h, int channels);
...
public:
	TexureSampler2F(float* data, int w, int h, int channels);
...
public:
	TexureSampler3F(float* data, int w, int h, int channels);
